...
const double yMax = 85;
const xOffset = xMax / 2;
const yOffset = yMax / 2;

//Rink dimensions
const double goalLineLength = 3.3528;
const double blueLineLength = 19.5072;
const double redLineLength = 7.62;
const double rinkWidth = 25.9;
const double rinkLength = 60.96;
const double halfRinkLength = goalLineLength + blueLineLength + redLineLength;
const double faceOffCircleRadius = 4.572;
const double xFaceOffCircle = 6.096 + goalLineLength;
const double yBenchFaceOffCircle = 6.245;
const double yOffBenchFaceOffCircle = rinkWidth - yBenchFaceOffCircle;
const double goalWidth = 1.82;
const double goalCreaseDiameter = 2.43;

String getColumnAbb(String value) {
  if (constantColumns.containsKey(value)) {
    return constantColumns[value];
  }
  _sendEvent('abb_not_found', {'abb': value});
  print('abb $value');
  return 'UNK';
}
...
String getColumnTooltip(String value) {
  ...
  _sendEvent('tooltip_not_found', {'tooltip': value});
  print('tooltip: $value');
  return 'UNK';
}
...
const Map<String, String> constantColumns = {
  ...
  'savePctDaysRest4Plus': '4+ Days Sv%',
  'penaltyShotSavePct': 'PS Sv%',
