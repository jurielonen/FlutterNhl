...
class PlayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (summaryView)
      return PlayerBioWidget.createSecondaryHeaderDivider('${play.about.ordinalNum} ${play.event}');
    else
      return PlayerBioWidget.createHeaderDivider('${play.about.ordinalNum} ${play.event}');
  }
}
              ...
              IconButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, Routes.video,
                        arguments: VideoArguments(play.video.videoUrl));
                  }),
            ],
          ),
        ),
