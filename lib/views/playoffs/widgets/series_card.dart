...
class SeriesCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PressableCard(child: _buildChild());
  }
  ...
  Iterable<Widget> get teamRows sync* {
    ...
    yield Text(series.seriesCurrentGame.seriesStatus, style: Styles.scaffoldGameWinnerText.copyWith(fontSize: 12),);
  }
      ...
      child: Opacity(
        ...
        child: Row(
          children: [
            ...
            Text.rich(TextSpan(text: team.rank.toString(), style: Styles.cardTeamWinnerMinorText, children: [
              TextSpan(text: ' ${team.abb}', style: Styles.scaffoldGameWinnerText)
            ])),
            Expanded(child: Text(team.wins.toString(), textAlign: TextAlign.end, style: Styles.scaffoldGameWinnerText),)
          ],
        ),
      ),
    );
